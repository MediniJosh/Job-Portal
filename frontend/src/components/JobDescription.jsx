...
const JobDescription = () => {
  ...
  try {
    ...
    if (msg === "You have already applied for this job") {
      setIsApplied(true); // Update state so button gets disabled
      toast.warning(msg); // Show friendly warning instead of red error
    } else {
      toast.error(msg); // For all other genuine errors
    }
